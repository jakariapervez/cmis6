...
function pa(a,b){a.j={X:b,ra:!0};a.h=a.l||a.u}
...
function ua(a){for(;a.h.h;)try{var b=a.i(a.h);if(b)return a.h.o=!1,{value:b.value,done:!1}}catch(c){a.h.m=void 0,pa(a.h,c)}a.h.o=!1;if(a.h.j){b=a.h.j;a.h.j=null;if(b.ra)throw b.X;return{value:b["return"],done:!0}}return{value:void 0,done:!0}}
...
b.prototype.u=function(g,h){if(0!=this.h)throw Error("Cannot settle("+g+", "+h+"): Promise already settled in state"+this.h);this.h=g;this.j=h;2===this.h&&this.fa();this.F()};
b.prototype.fa=function(){var g=this;e(function(){if(g.H()){var h=da.console;"undefined"!==typeof h&&h.error(g.j)}},1)};
...
return b}
;var Yb={};function Zb(a){if(a!==Yb)throw Error("Bad secret");}
...
r=oc.prototype;r.isEnabled=function(){if(!B.navigator.cookieEnabled)return!1;if(!this.isEmpty())return!0;this.set("TESTCOOKIESENABLED","1",{S:60});if("1"!==this.get("TESTCOOKIESENABLED"))return!1;this.remove("TESTCOOKIESENABLED");return!0};
...
function b(n){for(var p=g,q=0;64>q;q+=4)p[q/4]=n[q]<<24|n[q+1]<<16|n[q+2]<<8|n[q+3];for(q=16;80>q;q++)n=p[q-3]^p[q-8]^p[q-14]^p[q-16],p[q]=(n<<1|n>>>31)&4294967295;n=e[0];var v=e[1],w=e[2],y=e[3],F=e[4];for(q=0;80>q;q++){if(40>q)if(20>q){var fa=y^v&(w^y);var ib=1518500249}else fa=v^w^y,ib=1859775393;else 60>q?(fa=v&w|y&(v|w),ib=2400959708):(fa=v^w^y,ib=3395469782);fa=((n<<5|n>>>27)&4294967295)+fa+F+ib+p[q]&4294967295;F=y;y=w;w=(v<<30|v>>>2)&4294967295;v=n;n=fa}e[0]=e[0]+n&4294967295;e[1]=e[1]+v&4294967295;
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var l,m;a();return{reset:a,update:c,digest:d,ja:function(){for(var n=d(),p="",q=0;q<n.length;q++)p+="0123456789ABCDEF".charAt(Math.floor(n[q]/16))+"0123456789ABCDEF".charAt(n[q]%16);return p}}}
...
function vc(a){var b=sc();b.update(a);return b.ja().toLowerCase()}
...
function Bc(a){-1==a.i&&(a.i=Na(a.h,function(b,c,d){return c?b+Math.pow(2,d):b},0));
return a.i}
...
Rc.prototype.digest=function(){var a=[],b=8*this.m;56>this.j?this.update(this.l,56-this.j):this.update(this.l,this.i-(this.j-56));for(var c=this.i-1;56<=c;c--)this.o[c]=b&255,b/=256;Sc(this,this.o);for(c=b=0;5>c;c++)for(var d=24;0<=d;d-=8)a[b]=this.h[c]>>d&255,++b;return a};function Tc(){this.j=this.j;this.m=this.m}
Tc.prototype.j=!1;Tc.prototype.dispose=function(){this.j||(this.j=!0,this.K())};
Tc.prototype.K=function(){if(this.m)for(;this.m.length;)this.m.shift()()};var Uc="StopIteration"in B?B.StopIteration:{message:"StopIteration",stack:""};function Vc(){}
...
return a[Bd]}
;function N(){Tc.call(this);this.h=new kd(this);this.F=this;this.o=null}
G(N,Tc);N.prototype[gd]=!0;N.prototype.addEventListener=function(a,b,c,d){qd(this,a,b,c,d)};
...
var Hd=new Cc(function(){return new Gd},function(a){a.reset()});
...
O.prototype.$goog_Thenable=!0;O.prototype.cancel=function(a){if(0==this.h){var b=new Kd(a);Kc(function(){Ld(this,b)},this)}};
...
function Pd(a){a.o||(a.o=!0,Kc(a.u,a))}
...
function Nd(a,b,c,d){if(3==c&&b.onRejected&&!b.j)for(;a&&a.m;a=a.j)a.m=!1;if(b.h)b.h.j=null,Sd(b,c,d);else try{b.j?b.i.call(b.context):Sd(b,c,d)}catch(e){Td.call(null,e)}Dc(Hd,b)}
function Sd(a,b,c){2==b?a.i.call(a.context,c):a.onRejected&&a.onRejected.call(a.context,c)}
function Rd(a,b){a.m=!0;Kc(function(){a.m&&Td.call(null,b)})}
var Td=Gc;function Kd(a){Ja.call(this,a)}
G(Kd,Ja);Kd.prototype.name="cancel";function P(a){Tc.call(this);this.s=1;this.l=[];this.o=0;this.h=[];this.i={};this.u=!!a}
G(P,Tc);r=P.prototype;r.subscribe=function(a,b,c){var d=this.i[a];d||(d=this.i[a]=[]);var e=this.s;this.h[e]=a;this.h[e+1]=b;this.h[e+2]=c;this.s=e+3;d.push(e);return e};
...
function Wd(a,b,c){Kc(function(){a.apply(b,c)})}
...
Se.prototype.l=function(a){if(a.origin==R(this,"host")||a.origin==R(this,"host").replace(/^http:/,"https:")){try{var b=JSON.parse(a.data)}catch(c){return}this.j=!0;this.h||0!=a.origin.indexOf("https:")||(this.h=!0);if(a=Ue[b.id])a.u=!0,a.u&&(H(a.s,a.U,a),a.s.length=0),a.ba(b)}};
...
$e.i();function bf(a){var b=cf;a=void 0===a?C("yt.ads.biscotti.lastId_")||"":a;var c=Object,d=c.assign,e={};e.dt=qc;e.flash="0";a:{try{var f=b.h.top.location.href}catch(F){f=2;break a}f=f?f===b.i.location.href?0:1:2}e=(e.frm=f,e);e.u_tz=-(new Date).getTimezoneOffset();var g=void 0===g?M:g;try{var h=g.history.length}catch(F){h=0}e.u_his=h;e.u_java=!!M.navigator&&"unknown"!==typeof M.navigator.javaEnabled&&!!M.navigator.javaEnabled&&M.navigator.javaEnabled();M.screen&&(e.u_h=M.screen.height,e.u_w=M.screen.width,
...
l=b.h.top;try{var v=(l||window).document,w="CSS1Compat"==v.compatMode?v.documentElement:v.body;var y=(new Qb(w.clientWidth,w.clientHeight)).round()}catch(F){y=new Qb(-12245933,-12245933)}v=y;y={};w=new Ac;B.SVGElement&&B.document.createElementNS&&w.set(0);l=Xb();l["allow-top-navigation-by-user-activation"]&&w.set(1);l["allow-popups-to-escape-sandbox"]&&w.set(2);B.crypto&&B.crypto.subtle&&w.set(3);B.TextDecoder&&B.TextEncoder&&w.set(4);w=Bc(w);y.bc=w;y.bih=v.height;y.biw=v.width;y.brdim=k.join();b=
...
b.onFetchTimeout&&0<b.timeout&&(g=Ae(function(){f||(f=!0,window.clearTimeout(g),b.onFetchTimeout.call(b.context||B))},b.timeout))}else of(a,b)}
...
a.src="/generate_204"}
;var Af=B.ytPubsubPubsubInstance||new P,Bf=B.ytPubsubPubsubSubscribedKeys||{},Cf=B.ytPubsubPubsubTopicToKeys||{},Df=B.ytPubsubPubsubIsSynchronous||{};P.prototype.subscribe=P.prototype.subscribe;P.prototype.unsubscribeByKey=P.prototype.M;P.prototype.publish=P.prototype.J;P.prototype.clear=P.prototype.clear;E("ytPubsubPubsubInstance",Af);E("ytPubsubPubsubTopicToKeys",Cf);E("ytPubsubPubsubIsSynchronous",Df);E("ytPubsubPubsubSubscribedKeys",Bf);var T=window,U=T.ytcsi&&T.ytcsi.now?T.ytcsi.now:T.performance&&T.performance.timing&&T.performance.now&&T.performance.timing.navigationStart?function(){return T.performance.timing.navigationStart+T.performance.now()}:function(){return(new Date).getTime()};var Ef=We("initial_gel_batch_timeout",1E3),Ff=Math.pow(2,16)-1,Gf=null,Hf=0,If=void 0,Jf=0,Kf=0,Lf=0,Mf=!0,Nf=B.ytLoggingTransportGELQueue_||new Map;E("ytLoggingTransportGELQueue_",Nf);var Of=B.ytLoggingTransportTokensToCttTargetIds_||{};E("ytLoggingTransportTokensToCttTargetIds_",Of);
function Pf(a,b){if("log_event"===a.endpoint){var c="";a.B&&(Of[a.B.token]=Qf(a.B),c=a.B.token);var d=Nf.get(c)||[];Nf.set(c,d);d.push(a.payload);b&&(If=new b);c=We("web_logging_max_batch")||100;var e=U();d.length>=c?Rf({writeThenSend:!0}):10<=e-Lf&&(Sf(),Lf=e)}}
function Tf(a,b){if("log_event"===a.endpoint){var c="";a.B&&(Of[a.B.token]=Qf(a.B),c=a.B.token);var d=new Map;d.set(c,[a.payload]);b&&(If=new b);return new O(function(e){If&&If.isReady()?Uf(d,e,{bypassNetworkless:!0}):e()})}}
function Rf(a){a=void 0===a?{}:a;return new O(function(b){window.clearTimeout(Jf);window.clearTimeout(Kf);Kf=0;If&&If.isReady()?(Uf(Nf,b,a),Nf.clear()):(Sf(),b())})}
function Sf(){S("web_gel_timeout_cap")&&!Kf&&(Kf=Ae(Rf,6E4));window.clearTimeout(Jf);var a=Q("LOGGING_BATCH_TIMEOUT",We("web_gel_debounce_ms",1E4));S("shorten_initial_gel_batch_timeout")&&Mf&&(a=Ef);Jf=Ae(function(){Rf({writeThenSend:!0})},a)}
function Uf(a,b,c){var d=If;c=void 0===c?{}:c;var e=Math.round(U()),f=a.size;a=u(a);for(var g=a.next();!g.done;g=a.next()){var h=u(g.value);g=h.next().value;var k=h.next().value;h=Xa({context:Vf(d.h||Wf())});h.events=k;(k=Of[g])&&Xf(h,g,k);delete Of[g];Yf(h,e);S("send_beacon_before_gel")&&window.navigator&&window.navigator.sendBeacon&&!c.writeThenSend&&xf();Zf(d,"log_event",h,{retry:!0,onSuccess:function(){f--;f||b();Hf=Math.round(U()-e)},
onError:function(){f--;f||b()},
Z:c});Mf=!1}}
function Yf(a,b){a.requestTimeMs=String(b);S("unsplit_gel_payloads_in_logs")&&(a.unsplitGelPayloadsInLogs=!0);var c=Q("EVENT_ID",void 0);if(c){var d=Q("BATCH_CLIENT_COUNTER",void 0)||0;d||(d=Math.floor(Math.random()*Ff/2));d++;d>Ff&&(d=1);me("BATCH_CLIENT_COUNTER",d);c={serializedEventId:c,clientCounter:String(d)};a.serializedClientEventId=c;Gf&&Hf&&S("log_gel_rtt_web")&&(a.previousBatchInfo={serializedClientEventId:Gf,roundtripMs:String(Hf)});Gf=c;Hf=0}}
...
function Qf(a){var b={};a.videoId?b.videoId=a.videoId:a.playlistId&&(b.playlistId=a.playlistId);return b}
;var $f=B.ytLoggingGelSequenceIdObj_||{};E("ytLoggingGelSequenceIdObj_",$f);E("ytglobal.prefsUserPrefsPrefs_",C("ytglobal.prefsUserPrefsPrefs_")||{});var ag={bluetooth:"CONN_DISCO",cellular:"CONN_CELLULAR_UNKNOWN",ethernet:"CONN_WIFI",none:"CONN_NONE",wifi:"CONN_WIFI",wimax:"CONN_CELLULAR_4G",other:"CONN_UNKNOWN",unknown:"CONN_UNKNOWN","slow-2g":"CONN_CELLULAR_2G","2g":"CONN_CELLULAR_2G","3g":"CONN_CELLULAR_3G","4g":"CONN_CELLULAR_4G"};function bg(){return"INNERTUBE_API_KEY"in le&&"INNERTUBE_API_VERSION"in le}
function Wf(){return{innertubeApiKey:Q("INNERTUBE_API_KEY",void 0),innertubeApiVersion:Q("INNERTUBE_API_VERSION",void 0),ka:Q("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),la:Q("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:Q("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0),na:Q("INNERTUBE_CONTEXT_HL",void 0),ma:Q("INNERTUBE_CONTEXT_GL",void 0),oa:Q("INNERTUBE_HOST_OVERRIDE",void 0)||"",qa:!!Q("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),pa:!!Q("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
!1),appInstallData:Q("SERIALIZED_CLIENT_CONFIG_DATA",void 0)}}
function Vf(a){var b={client:{hl:a.na,gl:a.ma,clientName:a.la,clientVersion:a.innertubeContextClientVersion,configInfo:a.ka}},c=window.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=Q("EXPERIMENTS_TOKEN","");""!==c&&(b.client.experimentsToken=c);c=[];var d=Q("EXPERIMENTS_FORCED_FLAGS",{});for(e in d)c.push({key:e,value:String(d[e])});var e=Q("EXPERIMENT_FLAGS",{});for(var f in e)f.startsWith("force_")&&void 0===d[f]&&c.push({key:f,value:String(e[f])});0<c.length&&(b.request={internalExperimentFlags:c});
a.appInstallData&&(b.client.configInfo=b.client.configInfo||{},b.client.configInfo.appInstallData=a.appInstallData);Q("DELEGATED_SESSION_ID")&&!S("pageid_as_header_web")&&(b.user={onBehalfOfUser:Q("DELEGATED_SESSION_ID")});if(S("web_log_connection_in_gel")){a:{if(f=(a=B.navigator)?a.connection:void 0){a=ag[f.type||"unknown"]||"CONN_UNKNOWN";f=ag[f.effectiveType||"unknown"]||"CONN_UNKNOWN";"CONN_CELLULAR_UNKNOWN"===a&&"CONN_UNKNOWN"!==f&&(a=f);if("CONN_UNKNOWN"!==a)break a;if("CONN_UNKNOWN"!==f){a=
f;break a}}a=void 0}a&&(b.client.connectionType=a)}a=Object;f=a.assign;e=b.client;c={};d=u(Object.entries(Ie(Q("DEVICE",""))));for(var g=d.next();!g.done;g=d.next()){var h=u(g.value);g=h.next().value;h=h.next().value;"cbrand"===g?c.deviceMake=h:"cmodel"===g?c.deviceModel=h:"cbr"===g?c.browserName=h:"cbrver"===g?c.browserVersion=h:"cos"===g?c.osName=h:"cosver"===g?c.osVersion=h:"cplatform"===g&&(c.platform=h)}b.client=f.call(a,e,c);return b}
function cg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||Q("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Ia||Q("AUTHORIZATION"))||(a?b="Bearer "+C("gapi.auth.getToken")().Ha:b=zc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),S("pageid_as_header_web")&&(d["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return d}
;function dg(a){a=Object.assign({},a);delete a.Authorization;var b=zc();if(b){var c=new Rc;c.update(Q("INNERTUBE_API_KEY",void 0));c.update(b);b=c.digest();c=3;Ba(b);void 0===c&&(c=0);if(!Pb){Pb={};for(var d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""),e=["+/=","+/","-_=","-_.","-_"],f=0;5>f;f++){var g=d.concat(e[f].split(""));Ob[f]=g;for(var h=0;h<g.length;h++){var k=g[h];void 0===Pb[k]&&(Pb[k]=h)}}}c=Ob[c];d=[];for(e=0;e<b.length;e+=3){var l=b[e],m=(f=e+1<b.length)?
b[e+1]:0;k=(g=e+2<b.length)?b[e+2]:0;h=l>>2;l=(l&3)<<4|m>>4;m=(m&15)<<2|k>>6;k&=63;g||(k=64,f||(m=64));d.push(c[h],c[l],c[m]||"",c[k]||"")}a.hash=d.join("")}return a}
;function eg(a){var b=new ee;(b=b.isAvailable()?a?new ke(b,a):b:null)||(a=new fe(a||"UserDataSharedStore"),b=a.isAvailable()?a:null);this.h=(a=b)?new ae(a):null;this.i=document.domain||window.location.hostname}
eg.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.h)try{this.h.set(a,b,Date.now()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(Ed(b))}catch(f){return}else e=escape(b);b=this.i;pc.set(""+a,e,{S:c,path:"/",domain:void 0===b?"youtube.com":b,secure:!1})};
eg.prototype.get=function(a,b){var c=void 0,d=!this.h;if(!d)try{c=this.h.get(a)}catch(e){d=!0}if(d&&(c=pc.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
eg.prototype.remove=function(a){this.h&&this.h.remove(a);var b=this.i;pc.remove(""+a,"/",void 0===b?"youtube.com":b)};var fg;function gg(){fg||(fg=new eg("yt.innertube"));return fg}
...
function jg(a){var b=gg().get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(U())-d.requestTime)){var e=d.authState,f=dg(cg(!1));Wa(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(U())),Zf(a,d.method,e,{}));delete b[c]}}gg().set("requests",b,86400,!0)}}
;var kg=C("ytPubsub2Pubsub2Instance")||new P;P.prototype.subscribe=P.prototype.subscribe;P.prototype.unsubscribeByKey=P.prototype.M;P.prototype.publish=P.prototype.J;P.prototype.clear=P.prototype.clear;E("ytPubsub2Pubsub2Instance",kg);E("ytPubsub2Pubsub2SubscribedKeys",C("ytPubsub2Pubsub2SubscribedKeys")||{});E("ytPubsub2Pubsub2TopicToKeys",C("ytPubsub2Pubsub2TopicToKeys")||{});E("ytPubsub2Pubsub2IsAsync",C("ytPubsub2Pubsub2IsAsync")||{});E("ytPubsub2Pubsub2SkipSubKey",null);var lg=[],mg=!1;function ng(a,b){mg||(lg.push({type:"EVENT",eventType:a,payload:b}),10<lg.length&&lg.shift())}
...
x(og,Error);var pg={},qg=(pg.AUTH_INVALID="No user identifier specified.",pg.EXPLICIT_ABORT="Transaction was explicitly aborted.",pg.IDB_NOT_SUPPORTED="IndexedDB is not supported.",pg.MISSING_OBJECT_STORE="Object store not created.",pg.UNKNOWN_ABORT="Transaction was aborted for unknown reasons.",pg.QUOTA_EXCEEDED="The current transaction exceeded its quota limitations.",pg.QUOTA_MAYBE_EXCEEDED="The current transaction may have failed because of exceeding quota limitations.",pg.EXECUTE_TRANSACTION_ON_CLOSED_DB=
"Can't start a transaction on a closed database",pg),rg={},sg=(rg.AUTH_INVALID="ERROR",rg.EXECUTE_TRANSACTION_ON_CLOSED_DB="WARNING",rg.EXPLICIT_ABORT="IGNORED",rg.IDB_NOT_SUPPORTED="ERROR",rg.MISSING_OBJECT_STORE="ERROR",rg.QUOTA_EXCEEDED="WARNING",rg.QUOTA_MAYBE_EXCEEDED="WARNING",rg.UNKNOWN_ABORT="WARNING",rg);
function V(a,b,c,d){b=void 0===b?{}:b;c=void 0===c?qg[a]:c;d=void 0===d?sg[a]:d;og.call(this,c,Object.assign({name:"YtIdbKnownError",isSw:void 0===self.document,isIframe:self!==self.top,type:a,level:d},b));this.type=a;this.message=c;this.level=d;Object.setPrototypeOf(this,V.prototype)}
x(V,og);function tg(a){V.call(this,"MISSING_OBJECT_STORE",{Oa:a},qg.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,tg.prototype)}
...
function vg(a,b,c){if(a instanceof V)return a;if("QuotaExceededError"===a.name)return new V("QUOTA_EXCEEDED",{objectStoreNames:c,dbName:b});if(Nb&&"UnknownError"===a.name)return new V("QUOTA_MAYBE_EXCEEDED",{objectStoreNames:c,dbName:b});if("InvalidStateError"===a.name&&ug.some(function(d){return a.message.includes(d)}))return new V("EXECUTE_TRANSACTION_ON_CLOSED_DB",{objectStoreNames:c,
dbName:b});a.args=[{name:"IdbError",Pa:a.name,dbName:b,objectStoreNames:c,level:"WARNING"}];return a}
...
return g}
function Jg(a,b,c,d){tb(a,function f(){var g,h,k=this,l,m,n;return wa(f,function(p){if(1==p.h)return g=Math.round(U()),p.l=2,z(p,b,4);2!=p.h?(h=Math.round(U()),Kg(k,!0,c,h-g),p.h=0,p.l=0):(l=qa(p),m=Math.round(U()),n=m-g,l instanceof V&&("QUOTA_EXCEEDED"===l.type||"QUOTA_MAYBE_EXCEEDED"===l.type)&&ng("QUOTA_EXCEEDED",{dbName:k.h.name,objectStoreNames:c,transactionCount:k.transactionCount,transactionMode:d.mode}),l instanceof V&&"UNKNOWN_ABORT"===l.type&&(ng("TRANSACTION_UNEXPECTEDLY_ABORTED",{objectStoreNames:c,
transactionDuration:n,transactionCount:k.transactionCount,dbDuration:m-k.j}),k.i=!0),Kg(k,!1,c,n),mg||(lg.push({type:"ERROR",payload:l}),10<lg.length&&lg.shift()),p.h=0)})})}
function Kg(a,b,c,d){ng("TRANSACTION_ENDED",{objectStoreNames:c,connectionHasUnknownAbortedTransaction:a.i,duration:d,isSuccessful:b})}
...
r.update=function(a){return X(this.cursor.update(a))};function Ug(a,b,c){return tb(this,function e(){var f,g,h,k,l,m,n,p,q,v;return wa(e,function(w){if(1==w.h)return f=self.indexedDB.open(a,b),g=c,h=g.blocked,k=g.blocking,l=g.va,m=g.upgrade,n=g.closed,q=function(){p||(p=new Fg(f.result,{closed:n}));return p},f.addEventListener("upgradeneeded",function(y){if(null===y.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");
if(null===f.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");y.dataLoss&&"none"!==y.dataLoss&&ng("IDB_DATA_CORRUPTED",{reason:y.dataLossMessage||"unknown reason",dbName:a});var F=q(),fa=new Qg(f.transaction);m&&m(F,y.oldVersion,y.newVersion,fa)}),h&&f.addEventListener("blocked",function(){h()}),z(w,Dg(f),2);
v=w.m;k&&v.addEventListener("versionchange",function(){k(q())});
v.addEventListener("close",function(){ng("IDB_UNEXPECTEDLY_CLOSED",{dbName:a,dbVersion:v.version});l&&l()});
return w["return"](q())})})}
...
closed:b,va:b,upgrade:a.options.upgrade},d=function(){return tb(a,function g(){var h=this,k,l,m;return wa(g,function(n){switch(n.h){case 1:return n.l=2,z(n,Xg(h.name,h.options.version,c),4);case 4:k=n.m;if(!Kb){n.h=5;break}a:{var p=u(Object.keys(h.options.ta));for(var q=p.next();!q.done;q=p.next())if(q=q.value,!k.h.objectStoreNames.contains(q)){p=q;break a}p=void 0}l=p;if(void 0===l){n.h=5;break}if(!Kb||h.i){n.h=7;break}h.i=!0;return z(n,h["delete"](),8);case 8:return n["return"](d());case 7:throw new tg(l);
...
;var Zg=new Wg({ta:{databases:!0},upgrade:function(a,b){1>b&&a.h.createObjectStore("databases",{keyPath:"actualName"})}});
...
2;d={actualName:"yt-idb-test-do-not-use",publicName:"yt-idb-test-do-not-use",userIdentifier:void 0};return z(e,$g(d),4);case 4:return z(e,ah(),5);case 5:return e["return"](!0);case 2:return qa(e),e["return"](!1)}})})}
function dh(){if(void 0!==bh)return bh;mg=!0;return bh=ch().then(function(a){mg=!1;return a})}
;var eh;function fh(){eh||(eh=new eg("yt.offline"));return eh}
...
function jh(a){window.addEventListener("online",function(){a.l=!0;a.i&&Cd(a,"ytnetworkstatus-online");kh(a);if(a.s&&S("offline_error_handling")){var b=fh().get("errors",!0);if(b){for(var c in b)if(b[c]){var d=new og(c,"sent via offline_errors");d.name=b[c].name;d.stack=b[c].stack;d.level=b[c].level;qe(d)}fh().set("errors",{},2592E3,!0)}}})}
function ih(a){window.addEventListener("offline",function(){a.l=!1;a.i&&Cd(a,"ytnetworkstatus-offline");kh(a)})}
function kh(a){a.u&&(re(new og("NetworkStatusManager state did not match poll",U()-0)),a.u=!1)}
;function lh(a){a=void 0===a?{}:a;N.call(this);var b=this;this.l=this.u=0;gh.h||(gh.h=new gh);this.i=gh.h;this.i.i=!0;a.sa&&(this.i.s=!0);a.R?(this.R=a.R,td(this.i,"ytnetworkstatus-online",function(){mh(b,"publicytnetworkstatus-online")}),td(this.i,"ytnetworkstatus-offline",function(){mh(b,"publicytnetworkstatus-offline")})):(td(this.i,"ytnetworkstatus-online",function(){Cd(b,"publicytnetworkstatus-online")}),td(this.i,"ytnetworkstatus-offline",function(){Cd(b,"publicytnetworkstatus-offline")}))}
x(lh,N);function mh(a,b){a.R?a.l?(af(a.u),a.u=Ye(function(){a.s!==b&&(Cd(a,b),a.s=b,a.l=U())},a.R-(U()-a.l))):(Cd(a,b),a.s=b,a.l=U()):Cd(a,b)}
;var nh;function oh(a,b){b=void 0===b?{}:b;dh().then(function(){nh||(nh=new lh({sa:!0}));nh.i.l!==hh()&&re(new og("NetworkStatusManager isOnline does not match window status"));of(a,b)})}
function ph(a,b){b=void 0===b?{}:b;dh().then(function(){of(a,b)})}
;function qh(a){var b=this;this.h=null;a?this.h=a:bg()&&(this.h=Wf());Ze(function(){jg(b)},0,5E3)}
qh.prototype.isReady=function(){!this.h&&bg()&&(this.h=Wf());return!!this.h};
function Zf(a,b,c,d){!Q("VISITOR_DATA")&&"visitor_id"!==b&&.01>Math.random()&&re(new og("Missing VISITOR_DATA when sending innertube request.",b,c,d));if(!a.isReady()){var e=new og("innertube xhrclient not ready",b,c,d);qe(e);throw e;}var f={headers:{"Content-Type":"application/json"},method:"POST",postParams:c,postBodyFormat:"JSON",onTimeout:function(){d.onTimeout()},
...
timeout:d.timeout,withCredentials:!0},g="";(e=a.h.oa)&&(g=e);var h=a.h.qa||!1,k=cg(h,g,d);Object.assign(f.headers,k);f.headers.Authorization&&!g&&(f.headers["x-origin"]=window.location.origin);e="/youtubei/"+a.h.innertubeApiVersion+"/"+b;var l={alt:"json"};a.h.pa&&f.headers.Authorization||(l.key=a.h.innertubeApiKey);var m=Je(""+g+e,l||{},!0);(function(n){n=void 0===n?!1:n;var p;if(d.retry&&S("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=g&&(n||(p=hg(b,c,k,h)),p)){var q=f.onSuccess,v=f.onFetchSuccess;
f.onSuccess=function(w,y){ig(p);q(w,y)};
c.onFetchSuccess=function(w,y){ig(p);v(w,y)}}try{S("use_fetch_for_op_xhr")?lf(m,f):n&&d.retry&&!d.Z.bypassNetworkless?(f.method="POST",!d.Z.writeThenSend&&S("nwl_send_fast_on_unload")?ph(m,f):oh(m,f)):(f.method="POST",f.postParams||(f.postParams={}),of(m,f))}catch(w){if("InvalidAccessError"==w.name)p&&(ig(p),p=0),re(Error("An extension is blocking network request."));
else throw w;}p&&Ze(function(){jg(a)},0,5E3)})(!1)}
;function rh(a,b){var c=void 0===c?{}:c;var d=qh;Q("ytLoggingEventsDefaultDisabled",!1)&&qh==qh&&(d=null);c=void 0===c?{}:c;var e={};e.eventTimeMs=Math.round(c.timestamp||U());e[a]=b;var f=C("_lact",window);f=null==f?-1:Math.max(Date.now()-f,0);e.context={lastActivityMs:String(c.timestamp||!isFinite(f)?-1:f)};if(S("log_sequence_info_on_gel_web")&&c.ca){f=e.context;var g=c.ca;$f[g]=g in $f?$f[g]+1:0;f.sequence={index:$f[g],groupKey:g};c.Ma&&delete $f[c.ca]}(c.Ra?Tf:Pf)({endpoint:"log_event",payload:e,
B:c.B},d)}
...
r.ba=function(a){Lh(this,a.event,a)};
...
value:n}));rh("clientError",{errorMetadata:m,stackTrace:h,logMessage:f});Rf()}}if(!S("suppress_error_204_logging")){g=e;f=g.params||{};d={urlParams:{a:"logerror",t:"jserror",type:g.name,msg:g.message.substr(0,250),line:g.lineNumber,level:d,"client.name":f.name},postParams:{url:Q("PAGE_NAME",window.location.href),file:g.fileName},method:"POST"};f.version&&(d["client.version"]=f.version);if(d.postParams){g.stack&&(d.postParams.stack=g.stack);g=u(Object.keys(f));for(h=g.next();!h.done;h=g.next())h=h.value,
...
x(Z,Y);r=Z.prototype;r.W=function(){var a=R(this.i,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!=window.top&&document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));if(c=R(this.i,"embedConfig")){if(D(c))try{c=JSON.stringify(c)}catch(d){console.error("Invalid embed config JSON",d)}a.embed_config=c}return a};
r.ba=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(D(a))for(var c in a)this.D[c]=a[c];break;case "infoDelivery":Qh(this,a);break;case "initialDelivery":window.clearInterval(this.j);this.playerInfo={};this.D={};Rh(this,a.apiInterface);Qh(this,a);break;default:Lh(this,b,a)}};
