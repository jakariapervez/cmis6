...
$.ajax({
	...
	success:function(data) {
		console.log("Successfully returned ajax request");
		//console.log(data);
	$("#imagelist tbody").html(data.image_items);
...
// update progress Quantiy
  ...
  //$("#modal-ivt").on("submit",".js-progress-item-update-form",saveForm)
 $(".progresslink").click(function(e) {
	e.preventDefault();
	//console.log("successfully triggered scrolling")
	id=$($(this).attr("href"))
	//console.log(id)
...
// var contracts= JSON.parse($('#pdata').textContent);
 //console.log($('#pdata').textContent)
