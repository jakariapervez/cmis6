        ...
        public void DrawMyKhal2()
        {
            ...
            try
            {
              ...
              /*  lbprofile.drawProfile_WithLineType(draftingOrigin.X, 
               ...
               // dlprofile.drawProfile_WithLineType(draftingOrigin.X, draftingOrigin.Y - maximum_y_offset * dlprofile.yscale_factor, "DASHED2");
                    //drawProfile(draftingOrigin.X, draftingOrigin.Y - maximum_y_offset * dlprofile.yscale_factor);
